...
def main():
    ...
    if os.path.exists('/root/flag_server'):
        labels_file = '/root/project/Project_01/TextCNN/THUCNews/data/THUCNews_labels.txt'
    ...
    res = text_predict(files_list, labels_file, models_path, word2vec_path, batch_size)
    return res
